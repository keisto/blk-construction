...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>BLK Construction</title>
      </Head>

      <main className={styles.main}>
        <h1 className={styles.title}>BLK Construction</h1>
      ...
      <footer className={styles.footer}>
        <a
          ...
          href="https://www.angi.com/companylist/us/mt/helena/blk-construction-reviews-2052930.htm"
          target="_blank"
        >
          <svg
        ...
        <a
          className={styles.button}
          href="mailto:blkconstruction1000@gmail.com"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
        ...
        <a href="tel:+18088968724">(808) 896-8724</a>
      </footer>
    </div>
  )
}
